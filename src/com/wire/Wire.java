...
public class Wire {
     ...
     *
     * @param addTo  The Logic in which to add this connection
     * @param index  The index of the connection. Which position of the
     *               input/output node was it trying to connect to
     * @param output The WireInterface that output the wire
     * @param index2 The location in the list of wire from output to connect
     */
    ...
    /**
     * @param in The list of WireInterface
     */
     ...
     *
     * @param wireInputNode The bounds of the wire node
     * @param p             The point in which was selected
     */
     ...
     *
     * @param x1   The location x of the first node.
     * @param y1   The location y of the first node
     * @param x2   The location x of the second node
     * @param y2   The location y of the second node
     * @param endX The location of the second node to end at. Can be set to x2 if
     *             no gap is needed
     * @param box  The bound of the fist logic that the node is connect to.
     * @param box2 The bound of the second logic that the second node is connect
     *             to.
     **/

...
public class ExpandibleMenu extends Menu {
     ...
     * @param HIC    Number of items per row
     * @param XSpace The space between the items in the x-axe
     * @param YSpace The space between the items in the y-axe
     * @param width  The width of this menu
     **/
